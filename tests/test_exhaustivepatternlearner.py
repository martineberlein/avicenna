...
from avicenna.learning.exhaustive import AvicennaTruthTable, ExhaustivePatternCandidateLearner
...
class TestAvicennaIslearn(unittest.TestCase):
    ...
    def test_avicenna_islearn(self):
        avi_islearn = HeuristicTreePatternLearner(grammar)
        ...
        for cand in result:
            print("Candidate:")
            print(ISLaUnparser(cand[0]).unparse())
        ...
        result = avi_islearn.learn_candidates(
            new_inputs, exclude_nonterminals
        )
